    ...
    <div class="w-full max-w-lg mx-auto">
        ...
        <form action="#" class="bg-white p-8 pt-6 shadow-lg mb-5">
            <div class="mb-2">
                ...
                <input  type="text" v-model="lastName"  class="p-2 mb-3 rounded w-full block border">
            </div>
            <div class="mb-2">
            ...
            <div class="flex items-center justify-between py-2">
                <button type="submit"  class="bg-blue-500 text-white py-2 px-4 rounded" v-on:click="loginData">SOUMETTRE</button>
                <a href="#" class="text-blue-500 font-bold text-sm hover:bg-gray-700">Mot de passe Oublié</a>
            </div>
        </form>
    </div>
